...
### 4. Breakpoints
Usar las siguientes medidas para sus media queries **320px**, **768px** y **opcionalmente 1280px**. Se recomienda utilizar la estrategia _mobile first_.

`@media (min-width: 320px)`, `@media (min-width: 768px)` y opcionalmente ``@media (min-width: 1280px)``
