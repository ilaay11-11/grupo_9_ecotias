...
const productsController = {
  index: async (req, res) => {
    await db.Producto.findAll().then(function (products) {
  ...
  create: async (req, res) => {
    ...
    Promise.all([categories, makers]).then(([categories, makers]) => {
  ...
  detail: async (req, res) => {
    ...
    await db.Producto.findByPk(productId, {
      ...
      productSelected
        ...
        : res.render("products/product-not-found");
    });
  },
  edit: async (req, res) => {
    const productId = parseInt(req.params.id);
    ...
    Promise.all([categories, makers, product]).then(
      ([categories, makers, product]) => {
